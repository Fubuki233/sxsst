...
const STUDENT_NAV = [
  { id: 'dashboard', icon: Home, label: '首页', path: '/legacy' },
  { id: 'wrong-questions', icon: FileText, label: '错题本', path: '/legacy/wrong-questions' },
  { id: 'knowledge-map', icon: Map, label: '知识图谱', path: '/legacy/knowledge-map' },
  { id: 'profile', icon: User, label: '个人中心', path: '/legacy/profile' },
];
